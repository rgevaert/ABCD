...
?>
						<a href="../acquisitions/suggestions_new.php?encabezado=s&base=suggestions&cipar=suggestions.par" class="defaultButton multiLine newButton">
							<img src="../images/mainBox_iconBorder.gif" alt="" title="" />
...
?>
						<a href="../acquisitions/suggestions_status.php?base=suggestions&cipar=suggestions.par&sort=TI&encabezado=s" class="defaultButton multiLine checkButton">
							<img src="../images/mainBox_iconBorder.gif" alt="" title="" />
...
?>
						<a href="../acquisitions/order_new_menu.php?base=suggestions&sort=PV&encabezado=s" class="defaultButton multiLine newButton">
							<img src="../images/mainBox_iconBorder.gif" alt="" title="" />
			...
			<div class="mainBox" onmouseover="this.className = 'mainBox mainBoxHighlighted';" onmouseout="this.className = 'mainBox';">
				...
				<div class="boxContent dbSection">
					...
					<div class="sectionButtons">
						...
						<a href="../dataentry/browse.php?base=providers&modulo=acquisitions" class="defaultButton multiLine userButton">
							<img src="../images/mainBox_iconBorder.gif" alt="" title="" />
