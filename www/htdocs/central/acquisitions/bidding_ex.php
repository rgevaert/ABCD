...
echo "<a href=../dataentry/show.php?Mfn=".$arrHttp["Mfn"]."&base=".$arrHttp["base"]." target=_blank><img src=../images/zoom.png></a> &nbsp;<strong>".$valortag[18]."<br>".$msgstr["copies_approved"].":".$valortag[240]."</strong><br>";
echo "<br>";
if ($res=="LOCKREJECTED") {
	echo "<script>
