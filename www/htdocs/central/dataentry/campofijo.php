...
for (i=1;i<nSC;i++) {
	...
	if (s[11]==""){		document.writeln("<input type=text name=tag"+i+" size="+s[9]+" maxlength="+s[9]+" value='"+Contenido.substr(ixpos,s[9])+"'>")
		...
		if (s[4]==1)
   			...
   			multiple=" "        document.writeln("<select name=tag"+i+multiple+">")
...
<!--Las siguientes divisiones se utilizan para abrir la lista de autoridades o picklist del campo -->

<div id="dwindow" style="position:absolute;background-color:#EBEBEB;cursor:hand;left:0px;top:0px;display:none" onMousedown="initializedrag(event)" onMouseup="stopdrag()" onSelectStart="return false"><div align="right" style="background-color:navy"><ximg src="../img/max.gif" id="maxname" onClick="maximize()"><img src="../img/close.gif" onClick="closeit()"></div><div id="dwindowcontent" style="height:100%"><iframe id="cframe" src="" width=100% height=100% scrolling=yes></iframe></div></div>
