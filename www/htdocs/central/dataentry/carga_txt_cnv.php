...
echo "
	...
	echo "<font color=white>&nbsp; &nbsp; Script: carga_txt_cnv.php</font>";
	echo "
...
if (!file_exists($fpDb_fdt)) {
	...
	if (!file_exists($fpDb_fdt)){
  			echo $msgstr["falta"].": ".$arrHttp["base"]."/def/".$_SESSION["lang"]."/".$arrHttp["base"].".fdt";
		die;
	}
}
$fp=file($fpDb_fdt);
