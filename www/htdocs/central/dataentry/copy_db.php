...
<script>
function Explorar(){
	msgwin=window.open("dirs_explorer.php?desde=dbcp&Opcion=explorar&tag=document.forma1.dbfolder","explorar","width=400,height=600,top=0,left=0,resizable,scrollbars,menu")
    msgwin.focus()
}
