...
function ConfirmarCambio(){	msgwin=window.open("","cg","width=750,height=300,scrollbars,resizable")
	...
	msgwin.document.writeln("<html><title><?php echo $msgstr["mnt_globalc"] ?></title><body>")
	...
	msgwin.document.writeln("<strong><?php echo $msgstr["cg_tipoc"]?>: </strong>")
	mov=""
	...
	switch (mov){
	  	case "agregar":
	  		msgwin.document.writeln("<?php echo $msgstr["cg_add"]?><br>")
	  		break
	  	case "agregarocc":
	  		msgwin.document.writeln("<?php echo $msgstr["cg_addocc"]?><br>")
	  		break
	  	case "modificar":
	  		msgwin.document.writeln("<?php echo $msgstr["cg_modify"]?><br>")
	  		break
	  	case "modificarocc":
	  		msgwin.document.writeln("<?php echo $msgstr["cg_modifyocc"]?><br>")
	  		break
	  	case "dividir":
	  		msgwin.document.writeln("<?php echo $msgstr["cg_split"]?><br>")
	  		break
	 	case "mover":
	  		msgwin.document.writeln("<?php echo $msgstr["cg_move"]?><br>")
	  		break
	  	case "eliminar":
	  		msgwin.document.writeln("<?php echo $msgstr["cg_delete"]?><br>")
	  		break
	 	case "eliminarocc":
	 		msgwin.document.writeln("<?php echo $msgstr["cg_deleteocc"]?><br>")
	 		break
	}
...
?></textarea>
	...
	<tr>
		<td valign=top align=right><br>Select field:</td>
		<td align=left colspan=2><br>
			<Select name=global_C>
...
?>
					</select> <a href=../documentacion/ayuda.php?help=<?php echo$_SESSION["lang"]?>/cglobal.html#CAMPO target=_blank><img src=img/barHelp.png border=0 height=15></a></td>
	<tr><td colspan=4>&nbsp;</td>
	<tr>
