 ...
 * @file:      inicio_admin.php
 * @desc:      Start the program with administrator-level
...
<frameset rows=120,40,* cols=* border=0>
   <frame name=encabezado src=../dataentry/menubases.php?Opcion=Menu_o&base=acces&cipar=cipar.par&Mfn=<?echo $arrHttp["Mfn"]?>  MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=no FRAMEBORDER=NO>\n";
