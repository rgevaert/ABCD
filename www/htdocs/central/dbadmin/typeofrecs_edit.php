...
<table border=0 width=450>
	...
	<tr>
		<td width=80>".$msgstr["tag"]." 1</td><td align=left width=400><input type=text name=tipom value='' size=4></td>
	</tr>
	<tr>
		<td width=80>".$msgstr["tag"]." 2</td><td align=left width=400><input type=text name=nivelr value='' size=4></td>
	</tr>
...
<table border=0 width=450>
	...
	<tr>
		<td width=80>".$msgstr["tag"]." 1</td><td align=left width=400><input type=text name=tipom value='$tipom' size=3></td>
	</tr>
	<tr>
		<td width=80>".$msgstr["tag"]." 2</td><td align=left width=400><input type=text name=nivelr value='$nivelr' size=3></td>
	</tr>
