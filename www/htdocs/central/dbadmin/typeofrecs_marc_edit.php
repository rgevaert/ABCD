...
<table border=0>
	...
	<tr>
		<td align=left width=80>".$msgstr["tag"]." 1</td><td  align=left width=400><input type=text name=tipom value='$tipom' size=3></td>
	</tr>
	<tr>
		<td align=left width=80 align=left>".$msgstr["tag"]." 2</td><td align=left width=400><input type=text name=nivelr value='$nivelr' size=3></td>
	</tr>
