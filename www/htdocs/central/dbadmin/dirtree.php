...
global $arrHttp,$msgstr,$institution_name;
	echo "<Body>";
    if (isset($arrHttp["encabezado"]))
...
*/
    ...
    ?>
        <Tr>
            <Td><Center>
                <H3>UPLOAD File Extensions allowed:
    <?php
    ...
    <Table ALIGN="center" CELLPADDING="0" CELLSPACING="0" BGCOLOR="<?php $BGC;?>" class=td>
        <Tr>
            <Td VALIGN="top">
                ...
                <Font SIZE="3" COLOR="<?=$FGC;?>"><B>Refresh</A>
                ...
                <Font SIZE="3" COLOR="<?=$FGC;  ?>"><B>File Filter =</A>
    <?php
    If ($_SESSION['File_Extension'] == "") {
        Echo "*.*";
    } Else {
...
*/
    ...
    If ($_SESSION['Folder_Type'] [$NODE] == "File") {
    	...
    	$found=false;
    	$comp=array(".cnt",".mst",".xrf",".ifp",".n01",".n02",".l01",".l02",".php","isisuc.tab","isisac.tab",".exe");
