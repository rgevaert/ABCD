...
global $db_path;
	global $arrHttp;
	$fdt_c=$arrHttp["DocuManager"];
	$fp=explode("\n",$fdt_c);
	$arrHttp["dir"]=$db_path."documanager/";
	$fout=fopen($arrHttp["dir"]."documanager.fdt","w");
	$ix=0;
	echo "<p><dd><span class=title>".$arrHttp["dir"].$arrHttp["base"].".fdt"."</span>";
