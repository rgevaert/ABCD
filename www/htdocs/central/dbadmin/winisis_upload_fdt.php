...
global $arrHttp,$msgstr;
	...
	<td width=50 bgcolor=white>".$msgstr["tag"]."</td><td nowrap width=200 bgcolor=white>".$msgstr["description"]."</td><td width=50 nowrap bgcolor=white>".$msgstr["subfields"]."</td><td width=10 bgcolor=white>".$msgstr["repeat"]."</td>";
	$fdt=explode("\n",$Fdt_w);
	foreach ($fdt as $value){
		$f=explode('|',$value);
		$repetible="";
	...
	echo "</table>";
	echo "<h3><dd>" .$arrHttp["base"].".fdt ".$msgstr["converted"]."!</dd></h3>";
}
