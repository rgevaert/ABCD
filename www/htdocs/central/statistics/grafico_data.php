 ...
 * @file:      grafico_data.php
 * @desc:      PREPARE DATA TO SEND TO THE FLASH BROWSER
 *             The data preparation includes a routine that removes data accented characters
 *             because otherwise the plotter fails.
...
for ($i=0;$i<30;$i++){    $j=$i+1;	mt_srand((double)microtime()* 100000);
    ...
    foreach ($char["series_color"] as $value){    	if (abs($c-$value)<10){    		$c="";
    		$i=$i-1;
