...
echo "
<table>
<tr><td valign=top>1. ".$msgstr["uskey"]." (loans_uskey.pft)</td><td valign=top><input type=text name=uskey value=\"".$uskey."\"></td>
<tr><td valign=top>2. ".$msgstr["pft_uskey"]." (loans_uskey.pft)</td><td valign=top><textarea rows=2 cols=80 name=pft_uskey>".$pft_uskey."</textarea></td>
<tr><td valign=top>3. ".$msgstr["pft_ustype"] ." (loans_ustype.pft)</td><td valign=top><textarea rows=2 cols=80 name=pft_ustype>".$pft_ustype."</textarea></td>
<tr><td valign=top>4. ".$msgstr["pft_usvig"] ." (loans_usvig.pft)</td><td valign=top><textarea rows=2 cols=80 name=pft_usvig>".$pft_usvig."</textarea></td>
<tr><td valign=top>5. ".$msgstr["pft_usdisp"] ." (loans_usdisp.pft)</td><td valign=top><textarea rows=2 cols=80 name=pft_usdisp>".$pft_usdisp."</textarea></td>
</table>
";
