...
<td valign=top>
	...
	<td bgcolor=white align=center>
		...
		if (!empty($locales[2]["from"]) and !empty($locales[2]["to"])) echo " checked";
	...
	<td bgcolor=white align=center>
		...
		if (!empty($locales[3]["from"]) and !empty($locales[3]["to"])) echo " checked";
	...
	<td bgcolor=white align=center>
		...
		if (!empty($locales[4]["from"]) and !empty($locales[4]["to"])) echo " checked";
	...
	<td bgcolor=white align=center>
		...
		if (!empty($locales[5]["from"]) and !empty($locales[5]["to"])) echo " checked";
	...
	<td bgcolor=white align=center>
		...
		if (!empty($locales[6]["from"]) and !empty($locales[6]["to"])) echo " checked";
	...
	<td bgcolor=white align=center>
		...
		if (!empty($locales[0]["from"]) and !empty($locales[0]["to"])) echo " checked";
