...
?>
			...
			<table class="listTable">
				<tr>
					...
					<th>&nbsp;</th>
					<th><?php echo $msgstr["typeofusers"]?></th>
...
foreach ($lista_users as $value){
	...
	echo "<td class=\"action\">
		<a href=../dataentry/fmt.php?base=users&cipar=users.par&Mfn=$Mfn".$encabezado."&Opcion=editar><img src=\"../images/edit.png\" alt=\"".$msgstr["m_editar"]."\" title=\"".$msgstr["m_editar"]."\" /></a>";
	if ($Status==0) echo "
